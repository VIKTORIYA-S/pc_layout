const timer = () => {
  ...
  const updateTime = () => {
    ...
    daysBlock.nextElementSibling.textContent = numWords(days, [
      "день",
      "дня",
      "дней",
    ]);
    hoursBlock.nextElementSibling.textContent = numWords(hours, [
      "час",
      "часа",
      "часов",
    ]);
    minutesBlock.nextElementSibling.textContent = numWords(minutes, [
      "минута",
      "минуты",
      "минут",
    ]);
    secondsBlock.nextElementSibling.textContent = numWords(seconds, [
      "секунда",
      "секунды",
      "секунд",
    ]);
